 ...
 */
package com.dws.wardrobeos.api.widget;
...
import com.dws.wardrobeos.utils.AlbumUtils;
...
public class Widget implements Parcelable {
    ...
    private Widget(Builder builder) {
        ...
        this.mStatusBarColor = builder.mStatusBarColor == 0 ?
                ContextCompat.getColor(mContext, R.color.colorPrimaryDark) : builder.mStatusBarColor;
        this.mToolBarColor = builder.mToolBarColor == 0 ?
                ContextCompat.getColor(mContext, R.color.colorPrimary) : builder.mToolBarColor;
        ...
        this.mTitle = TextUtils.isEmpty(builder.mTitle) ? mContext.getString(R.string.app_name) : builder.mTitle;
    ...
    public static class ButtonStyle implements Parcelable {
        ...
        private ButtonStyle(Builder builder) {
            ...
            this.mButtonSelector = builder.mButtonSelector == null ?
                    AlbumUtils.getColorStateList(ContextCompat.getColor(mContext, R.color.colorPrimary),
                            ContextCompat.getColor(mContext, R.color.colorPrimaryDark)
                    ) :
        ...
        return Widget.newDarkBuilder(context)
                ...
                .buttonStyle(
                        ButtonStyle.newDarkBuilder(context)
                                .setButtonSelector(ContextCompat.getColor(context, R.color.colorPrimary),
